...
#'
#' @format A matrix with 6 rows and 6 variables:
#' \describe{
...
#'   \item{donor4}{numeric kinship (0-1) with donor 4}
#'   \item{donor5}{numeric kinship (0-1) with donor 5}
#'   \item{donor6}{numeric kinship (0-1) with donor 6}
#' }
